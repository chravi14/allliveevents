    ...
    return (
        <div className="home">
            ...
            <div className="home-intro mt-5">
                ...
                {showLoginMsg && <p style={{ color: "red" }}>Please click <a className="btn btn-danger" href="https://aaliveevents.memberspace.com/member/sign_in">Join Now / Login</a> to create an account and purchase a daily pass of $10 to access the Tournaments page.</p>}
